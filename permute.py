...
def convert2Bin(s):
    ...
    size = len(s) * 4
    convert = (bin(int(s, 16))[2:]).zfill(size)
    return convert



# permutation
def permutation(pt, table, n):
    permuted = ""
    for i in range(0, n):
...
print("Convert to bin of IP: ",convert2Bin(ipData))
print("Result of IP        : ", permutation(convert2Bin(ipData), IP, 64))
print()
